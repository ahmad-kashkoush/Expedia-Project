...
#ifndef EXPEDIA_PROJECT_CUSTOMERVIEW_H
#define EXPEDIA_PROJECT_CUSTOMERVIEW_H
#include "CustomerManager.h"
#include "Utilities.h"
class CustomerView {
private:
    CustomerMgr &customer_manager;
    const Customer &customer;
    Itenerary current_itinerary;
...
#endif //EXPEDIA_PROJECT_CUSTOMERVIEW_H
